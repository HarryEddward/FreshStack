...
const filePath = './app.pdf'; // Asegúrate de que app.pdf esté en el directorio
const objectPath = 'pdftetsing';
const sessionId = 'cjdPeFY1YjdXNDc5WFFEMkplQk5q.inmGQa1/m6P/NYufUFTtEnVxxriZNXspa0OM51ThgF0';
