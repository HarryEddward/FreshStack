...
export default function LangBusinessWebAppDashboardInventoryIslandProductsSettingCreateProduct({
                        ...
                        <div className="flex items-center gap-4">
                            <div className={"w-full flex flex-row justify-between"}>
                                ...
                                <p className="text-sm text-gray-600 mt-1">
                                    Crea tu producto de la forma mas practica posible.
                                </p>
                                </div>
                                <button
